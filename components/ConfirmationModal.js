            ...
            <div className="modalOverlay relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div className="mt-3 text-center">
                    ...
                    <div className="items-center px-4 py-3">
                        <div>&nbsp;</div>
                        <a href="#" onClick={handleCloseClick} id="ok-btn" className="px-4 py-2 bg-red-500 text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-300" >
                            Close
                        </a>
                    </div>
                </div>
