      ...
      <div className="h-screen flex flex-col items-center justify-center">
        <div className=" -mt-32">
          ...
          <div className="grid grid-cols-2 gap-16">
            ...
            <div className="flex flex-col items-center px-6 py-8 bg-white rounded-xl shadow-sm  hover:text-white hover:bg-slate-400 hover:border-1 hover:cursor-pointer hover:shadow-xl">
              <div className="pt-14">
                <Image
                  layout="intrinsic"
                  className=""
